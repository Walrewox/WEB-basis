<?php  $urls = ['assets/img/photos/Linus.jpg',
       ...
       $i = rand(0,2);
       if ($i==0) {
         echo "<p class=\"text-center\"><img src=\"$urls[$i]\" alt=\"Лінус Торвальдс\"></p>";
       ...
       elseif ($i==1) {
         echo "<p class=\"text-center\"><img src=\"$urls[$i]\" alt=\"Кріс Метцен\" width=75% height=75%><p>";
         ...
         echo "<p class=\"text-center\"><img src=\"$urls[$i]\" alt=\"Джим Керрі\" width=35% height=35%></p>";
